    ...
    <div class="pb-0 mt-4 mb-0">
        <form method="POST">
            <div class="form-group">
                ...
                <a href="./media/Downloads/" class="btn btn-link" role="button">Down</a>
                <a href="./terminal.php" class="btn btn-link" role="button">Terminal</a>
                <a href="./ariang.html" class="btn btn-link" role="button">Aria2</a>
